...
<script>
  ...
  class ParticleSystem {
    constructor(canvas) {
      ...
      for (let i = 0; i < 50; i++) this.particles.push(this.create());
      this.animate();
    }
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('btn-clear').onclick = function() { input.value=''; output.value=''; statusText.textContent='Ready'; };
  });
<` + `/script>
`;
